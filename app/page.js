    ...
    <div className="flex flex-col pt-16">
       <section className="mt-20 pb-12 space-y-10 md:space-y-20 px-5">
        <div className="container mx-auto px-4 md:px-6 text-center space-y-6">
          ...
          <h1 className="gradient-title mx-auto max-w-4xl font-bold md:text-7xl">The smartest way to split expenses with friends</h1>
          ...
          <Button asChild variant="outline" size={"lg"} className="bg-green-600 hover:bg-green-700">
                <Link href="/dashboard">
                  Get Started
       ...
       <section id="features" className="bg-gray-50 py-20">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="mx-auto mt-3 max-w-[700px] text-gray-500 md:text-xl/relaxed">Our platform provides all the tools you need to handle shared expenses with ease.</p>
       ...
       <section id="how-it-works" className="py-20">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="mx-auto mt-3 max-w-[700px] text-gray-500 md:text-xl/relaxed">Follow these simple steps to start tracking and splitting expenses with friends.</p>
